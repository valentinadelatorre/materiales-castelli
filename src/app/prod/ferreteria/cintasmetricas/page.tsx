...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/VN5ydYpd/Screenshot-2025-04-24-at-11-53-18-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/VN5ydYpd/Screenshot-2025-04-24-at-11-53-18-PM.png',
            'https://i.postimg.cc/LXBVSPDf/Screenshot-2025-04-24-at-11-53-44-PM.png',
            'https://i.postimg.cc/fRnkcPDz/Screenshot-2025-04-24-at-11-54-59-PM.png',
            'https://i.postimg.cc/RVMvvzSn/Screenshot-2025-04-24-at-11-55-40-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- CINTA MÉTRICA 3mts REFORZADA</p>
    <p>- CINTA MÉTRICA 5mts REFORZADA</p>
    <p>- CINTA MÉTRICA 7mts REFORZADA</p>
    <p>- CINTA AGRIMENSOR 30mts REFORZADA</p>
  </p>
