...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/XqZdfhRg/Screenshot-2025-04-25-at-8-48-24-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/XqZdfhRg/Screenshot-2025-04-25-at-8-48-24-PM.png',
            'https://i.postimg.cc/rpQrvMcJ/Screenshot-2025-04-26-at-12-01-04-PM.png',
            'https://i.postimg.cc/vBK6Zh4x/Screenshot-2025-04-25-at-8-49-43-PM.png',
            'https://i.postimg.cc/3rPnLCtw/Screenshot-2025-04-25-at-8-50-05-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- DISCO DE SIERRA 4 1/2 x 24 DIENTES ROTTWEILER</p>
    <p>- DISCO DE CORTE TYROLIT SECUR 115 x 1,6</p>
    <p>- DISCO DE CORTE TYROLIT XPERT 178 x 1,6</p>
    <p>- DISCO DIAMANTADO PROF. LASER 115</p>
    <p>- DISCO DIAMANTADO PROF. CONTINUO 115</p>
    <p>- DISCO DIAMANTADO PROF. TURBO 115</p>
    <p>- DISCO PORCELLANATO ULTRA FINO KLEBER</p>
  </p>
