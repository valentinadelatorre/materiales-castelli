...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/4yqLVj36/Screenshot-2025-04-26-at-12-18-57-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/4yqLVj36/Screenshot-2025-04-26-at-12-18-57-PM.png',
            'https://i.postimg.cc/TwPCSTLj/Screenshot-2025-04-26-at-12-20-44-PM.png',
            'https://i.postimg.cc/3Jp59ZH8/Screenshot-2025-04-26-at-12-23-02-PM.png',
            'https://i.postimg.cc/MpmkJKTg/Screenshot-2025-04-26-at-12-23-19-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- ESPÁTULA DE PINTOR DESDE 3cm a 10cm TODAS LAS MEDIDAS</p>
    <p>- ESPÁTULA DE PINTOR 12, 14, 16, 18cm </p>
  </p>
