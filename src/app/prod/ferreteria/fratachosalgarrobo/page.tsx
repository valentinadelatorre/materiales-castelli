...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/xdBBKkFJ/Screenshot-2025-04-26-at-12-34-58-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/xdBBKkFJ/Screenshot-2025-04-26-at-12-34-58-PM.png',
            'https://i.postimg.cc/QC3Py2Dj/Screenshot-2025-04-26-at-12-35-17-PM.png',
            'https://i.postimg.cc/fyfFn8Wm/Screenshot-2025-04-26-at-12-35-45-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- FRATACHO ABRASIVO</p>
    <p>- FRATACHO ALGARROBO 25cm ANEMI</p>
    <p>- FRATACHO ALGARROBO 30cm ANEMI</p>
    <p>- FRATACHO ALGARROBO 35cm ANEMI</p>
    <p>- FRATACHO ALGARROBO 40cm ANEMI</p>
    <p>- FILTRO GOMA ESPUMA</p>
  </p>
