...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/MpBy8SJN/Screenshot-2025-05-01-at-12-31-55-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/MpBy8SJN/Screenshot-2025-05-01-at-12-31-55-PM.png',
            'https://i.postimg.cc/mDm9SZ7z/Screenshot-2025-05-01-at-12-32-10-PM.png',
            'https://i.postimg.cc/c4g3QSCC/Screenshot-2025-05-01-at-12-31-37-PM.png',
            'https://i.postimg.cc/gJ2Xr91Y/Screenshot-2025-05-01-at-12-31-10-PM.png',
            'https://i.postimg.cc/vT14LrQk/Screenshot-2025-05-01-at-12-30-38-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- RODILLO BAMBIN POLYESTER 22CM</p>
    <p>- RODILLO MINI COMUN</p>
    <p>- PINCEL BAMBIN LINEA 189 Nº15</p>
    <p>- PINCEL BAMBIN LINEA 189 Nº20</p>
    <p>- PINCEL BAMBIN LINEA 189 Nº25</p>
  </p>
