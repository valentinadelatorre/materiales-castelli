...
export default function RevestimientosPage() {
  ...
  Revestimientos
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
          ...
          {/* Tarjeta 1 */}
          <div className="bg-neutral-900 rounded-2xl shadow-lg shadow-[#05aced] overflow-hidden transition hover:scale-[1.02] p-6 text-center">
            <img
            ...
            <a
            href="#formulario"
            className="border border-[#05aced] text-white font-semibold px-6 py-2 rounded-full hover:bg-white hover:text-black transition"
            >
            Contactanos
            </a>
  ...
  {/* Tarjeta 13 */}
  <div className="w-90 h-[430px] bg-neutral-900 rounded-2xl shadow-lg shadow-[#05aced] overflow-hidden transition hover:scale-[1.02] p-6 text-center">
    <img
    ...
    <a
       ...
       {/* CONTACTO */}
      <section id="formulario" className="py-20 px-4 bg-black text-white mt-15 text-center">
