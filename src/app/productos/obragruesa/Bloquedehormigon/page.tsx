...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/6QHCHYm8/Screenshot-2025-04-24-at-2-13-10-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/6QHCHYm8/Screenshot-2025-04-24-at-2-13-10-PM.png',
            'https://i.postimg.cc/VLjnyYhQ/Screenshot-2025-04-24-at-2-14-04-PM.png',
            'https://i.postimg.cc/LXcY77B8/Screenshot-2025-04-24-at-2-15-45-PM.png',
            'https://i.postimg.cc/8kvrWpNJ/Screenshot-2025-04-24-at-2-09-35-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- BLOQUE DE HORMIGÓN 20x20x40</p>
    <p>- BLOQUE DE HORMIGÓN 13x20x40</p>
    <p>- BLOQUE DE HORMIGÓN 20x20x40 MITAD</p>
    <p>- BLOQUE DE HORMIGÓN 20x20x40 UFD</p>
    <p>- BLOQUE DE HORMIGÓN SIMIL PIEDRA 20x20x40</p>
  </p>
