...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/L6yBRGZ6/Screenshot-2025-04-24-at-10-03-54-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/L6yBRGZ6/Screenshot-2025-04-24-at-10-03-54-PM.png',
            'https://i.postimg.cc/XYmfBF8R/Screenshot-2025-04-24-at-10-06-21-PM.png',
            'https://i.postimg.cc/mDG78sKV/Screenshot-2025-04-24-at-10-06-44-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- MAPEI CERAMICOS x 30kg (KERAFLOR)</p>
    <p>- MAPEI PORCELANATO x 30 kg (KERABOND)</p>
    <p>- MAPEI ADESILEX P9 PORCELLANATO, BLANCO 25kg</p>
  </p>
