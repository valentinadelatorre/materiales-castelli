...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/V6Bk1Qv7/Screenshot-2025-04-24-at-9-30-35-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/V6Bk1Qv7/Screenshot-2025-04-24-at-9-30-35-PM.png',
            'https://i.postimg.cc/qq1Bhs8y/Screenshot-2025-04-24-at-9-31-09-PM.png',
            'https://i.postimg.cc/66cpmXDq/Screenshot-2025-04-24-at-9-31-37-PM.png',
            'https://i.postimg.cc/Ghpm0fCQ/Screenshot-2025-04-24-at-9-33-07-PM.png',
            'https://i.postimg.cc/dtStJ9QK/Screenshot-2025-04-24-at-9-33-41-PM.png',
            'https://i.postimg.cc/4xDf9NhL/Screenshot-2025-04-24-at-9-34-43-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- TEJUELA 2cm. 229 x 114 x 22 mm</p>
    <p>- LADRILLO RECTO 229 x 114 x 63 mm</p>
    <p>- BOLSA ARCILLA REFRACTARIA 5kg</p>
    <p> - BOLSA ARCILLA REFRACTARIA 10kg</p>
    <p> - BOLSA ARCILLA REFRACTARIA 30kg</p>
    <p>- LISTON 220 x 60 x 22 mm</p>
    <p>- MEDIO ESQUINERO COLOR 150 x 60 x 25 (x 60) mm</p>
    <p>- MEDIO ESQUINERO SIN COLOR 150 x 60 x 25 (X 60) mm</p>
  </p>
