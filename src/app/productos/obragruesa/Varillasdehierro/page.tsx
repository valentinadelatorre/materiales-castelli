...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/qR4jh47K/Screenshot-2025-04-23-at-5-11-21-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/0NgtvpRc/Screenshot-2025-04-23-at-5-09-50-PM.png',
            'https://i.postimg.cc/fbx8RJMZ/Screenshot-2025-04-23-at-5-10-33-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- HIERRO ADN 4,2mm EN VARILLA DE 12mts</p>
    <p>- HIERRO ADN 6mm EN VARILLA DE 12mts</p>
    <p>- HIERRO ADN 8mm EN VARILLA DE 12mts</p>
    <p>- HIERRO ADN 10mm EN VARILLA DE 12mts</p>
    <p>- HIERRO ADN 12mm EN VARILLA DE 12mts</p>
    <p>- HIERRO ADN 16mm EN VARILLA DE 12mts</p>
  </p>
