...
export default function AditivosVinilicos() {
  const [mainImage, setMainImage] = useState('https://i.postimg.cc/9QBm5pCZ/Screenshot-2025-04-24-at-12-13-16-PM.png');
    ...
    <div className="bg-black min-h-screen py-16 px-4 text-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 bg-white text-black rounded-2xl drop-shadow-[0_10px_25px_#05aced] p-6 w-full max-w-5xl mx-auto transition hover:-translate-y-1 hover:shadow-[0_20px_50px_-10px_#05aced]">
        ...
        <div className="flex md:flex-col gap-4">
          {[
            'https://i.postimg.cc/9QBm5pCZ/Screenshot-2025-04-24-at-12-13-16-PM.png',
            'https://i.postimg.cc/765wzr7n/Screenshot-2025-04-24-at-12-13-58-PM.png',
            'https://i.postimg.cc/3Rz7CfF5/Screenshot-2025-04-24-at-12-14-42-PM.png',
  ...
  <p className="text-black text-sm mb-4 font-bold w-full text-center">
    <p>- YESO TUYANGO TRADICIONAL 30kg</p>
    <p>- YESO TUYANGO PROYECTABLE 30kg</p>
    <p>- YESO ENTRE RIOS TRADICIONAL - 40kgs</p>
  </p>
